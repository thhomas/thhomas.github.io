      ...
      if(layerData) {
        ...
        if(layerData.TileMatrixSetLink !== undefined && layerData.TileMatrixSetLink.length > 0) {
          this.olLayer = new ol.layer.Tile({
            ...
            //extent: ol.proj.transformExtent([layerData.WGS84BoundingBox[0],layerData.WGS84BoundingBox[2],layerData.WGS84BoundingBox[1],layerData.WGS84BoundingBox[3]], 'EPSG:4326', 'EPSG:3857'),
    ...
    return $.when.apply($, requests).done(function() {
      ...
      if (self.urls.length > 1) {
        ...
        for ( var i = 0; i < responses.length; i++) {
          ...
          layers.push({
            url : result.OperationsMetadata.GetCapabilities.DCP.HTTP.Get[0].href,
